    ...
    open class Impact {
        ...
        public func feedback(_ style: ImpactStyle) {
            DispatchQueue.main.async {
                ...
                self.updateGeneratorIfNeeded(style)
                
                guard let generator = self.generator as? UIImpactFeedbackGenerator else { return }
