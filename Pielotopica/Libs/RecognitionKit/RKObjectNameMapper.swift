...
private let yoloObjectLabel_ja = [
    ...
    "ゾウ","クマ","ゼブラ","キリン","カバン","傘","ハンドバッグ","ネクタイ","スーツケース","フリスビー",
    "スキー","スノーボード","ボール","凧","バット","グローブ","スケートボード","サーフボード","テニスラケット","ボトル",
    "ワイングラス","カップ","フォーク","ナイフ","スプーン","ボール","バナナ","リンゴ","サンドイッチ","オレンジ",
    "ブロッコリー","にんじん","ホットドッグ","ピザ","ドーナツ","ケーキ","イス","ソファー","鉢植え","ベッド",
    "テーブル","トイレ","モニター","ノートパソコン","マウス","リモコン","キーボード","携帯電話","電子レンジ","オーブン",
    "トースター","流し台","冷蔵庫","本","時計","花瓶","はさみ","テディベア","ドライヤー","歯ブラシ"
]
